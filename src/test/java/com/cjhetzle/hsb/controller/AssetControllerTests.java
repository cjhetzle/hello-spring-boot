...
public class AssetControllerTests {
    ...
    void setUp() {
        ...
        refAsset2 = repository.save(
                new Asset(refAsset2.getName(), refAsset2.getIsPromoted()));
        refAsset3 = repository.save(
                new Asset(refAsset3.getName(), refAsset3.getIsPromoted()));
    }

    @Test
    void getAssetByIdTest() {
        assertThat(controller.getAsset(refAsset1.getId())).isEqualTo(refAsset1);

        assertThat(controller.getAsset(refAsset2.getId())).isEqualTo(refAsset2);

        assertThat(controller.getAsset(refAsset3.getId())).isEqualTo(refAsset3);
    }

    @Test
    void getAllAssetsTest() {
        assertThat(controller.getAssets()).hasSize(3).contains(refAsset1,
                refAsset2, refAsset3);
    }
    ...
    void createAssetsTest() {
        ...
        assertThat(controller.createAsset(refAsset4)).contains(
                refAsset4.getName(), String.valueOf(refAsset4.getId()),
                refAsset4.getIsPromoted().toString());

        assertThat(controller.getAssets()).contains(refAsset4);
    }
    ...
    void deleteAssetByIdTest() {
        ...
        assertThat(controller.getAssets()).doesNotContain(refAsset3);
    }

    @Test
    void promoteAssetByIdTest() {
        assertThat(controller.getAsset(refAsset1.getId()).getIsPromoted())
